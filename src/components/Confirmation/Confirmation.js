...
const Confirmation = () => {
  ...
  useEffect(() => {
    ...
    if (droneElement) {
      setTimeout(() => {
        droneElement.classList.add('fly-in');
      }, 500);
    }
  }, [navigate]);
  ...
  return (
    <div className="confirmation-page">
      <div className="drone-animation">
        <img src="/images/drone.png" alt="Delivery Drone" className="drone-image" />
      </div>
      ...
      <div className="confirmation-content">
        ...
        <div className="confirmation-details">
          <div className="detail-section">
            ...
            <p>{orderDetails.deliveryAddress.city}, {orderDetails.deliveryAddress.postalCode}</p>
          </div>
          
          <div className="detail-section">
            <h3>Payment Method</h3>
            <p>{orderDetails.paymentMethod === 'creditcard' ? 'Credit Card' : 'Swish'}</p>
          </div>
        </div>
        ...
        <div className="action-buttons">
          <Link to="/menu" className="btn-secondary">Order More Food</Link>
